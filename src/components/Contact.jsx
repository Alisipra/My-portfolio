...
export default function Contact() {
  return (
    <>
      <div
        data-aos="fade-up"
        className="bg-[#121212] py-8 px-4 sm:py-16 xl:px-16 aos-init aos-animate mt-[130px]"
      >
        <div>
          <h1
            data-aos="fade-up"
            className="text-center text-5xl lg:text-6xl text-white font-bold aos-init aos-animate"
          >
            Contact
          </h1>
          <ul
            data-aos="fade-up"
            className="space-y-8 md:px-4 py-16 lg:py-16 aos-init aos-animate"
          >
            <li className="bg-[#121212] rounded-full w-16 h-16 lg:w-20 lg:h-20 border-2 border-purple-500 relative">
              <svg
                ...
                stroke-width="0"
                viewBox="0 0 24 24"
                className="text-purple-500 text-3xl lg:text-5xl absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                height="1em"
                width="1em"
              ...
              <svg
                ...
                stroke-width="0"
                viewBox="0 0 384 512"
                className="text-purple-500 text-3xl lg:text-5xl  absolute transform -translate-x-1/8 -translate-y-1/2 top-1/2 -right-[70%] lg:-right-[85%] "
                height="1em"
                width="1em"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <li className="bg-[#121212] rounded-full w-16 h-16 lg:w-20 lg:h-20 border-2 border-purple-500 relative">
              ...
              <svg
                ...
                stroke-width="0"
                viewBox="0 0 384 512"
                className="text-purple-500 text-3xl lg:text-5xl  absolute transform -translate-x-1/8 -translate-y-1/2 top-1/2 -right-[85%] "
                height="1em"
                width="1em"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <h1 className="text-white absolute transform -translate-x-1/8 -translate-y-1/2 top-1/2 -right-[330%] sm:-right-[380%] md:-right-[410%] lg:-right-[370%] text-[16px] sm:text-[19px] md:text-[21px] lg:text-[22px] lg:left-[290%] left-[200%]">
                Sargodha,Punjab Pakistan
              </h1>
            </li>
          </ul>
          <div className="border-t border-neutral-700 py-2 aos-init aos-animate"></div>
          <div className="flex justify-center items-center space-x-6 ">
            <a
              href="https://linkedin.com/in/ali-ijaz-a749a0246/"
              target="_blank"
            >
              {" "}
              <svg
                ...
                baseProfile="tiny"
                viewBox="0 0 24 24"
                className="text-neutral-600 hover:text-purple-500 transition-all duration-200 cursor-pointer aos-init aos-animate"
                height="53"
                width="53"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <a href="https://github.com/Alisipra" target="_blank">
              {" "}
              <svg
                stroke="currentColor"
                fill="currentColor"
